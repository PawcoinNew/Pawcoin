...
This means one can have an always-on pawcoind instance running, and another local pawcoind/pawcoin-qt instance which connects to this node and receives blocks from it.
