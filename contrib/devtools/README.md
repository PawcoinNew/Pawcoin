...
Provides utilities for managing copyright headers of `The PWC
...
Setup
---------
Configuring the github-merge tool for the PWC repository is done in the following way:

    git config githubmerge.repository PWC-Project/PWC
...
A script to optimize png files in the PWC
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_pawcoin: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_pawcoin: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_pawcoin: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_pawcoin: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
