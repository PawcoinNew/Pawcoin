...
RESOURCES += src/qt/pawcoin.qrc src/qt/pawcoin_locale.qrc

TRANSLATIONS += src/qt/locale/pawcoin_bg.ts \
                src/qt/locale/pawcoin_de.ts \
                src/qt/locale/pawcoin_en.ts \
                src/qt/locale/pawcoin_es.ts \
                src/qt/locale/pawcoin_fi.ts \
                src/qt/locale/pawcoin_fr.ts \
                src/qt/locale/pawcoin_it.ts \
                src/qt/locale/pawcoin_ja.ts \
                src/qt/locale/pawcoin_pl.ts \
                src/qt/locale/pawcoin_pt.ts \
                src/qt/locale/pawcoin_ru.ts \
                src/qt/locale/pawcoin_sk.ts \
                src/qt/locale/pawcoin_sv.ts \
                src/qt/locale/pawcoin_vi.ts \
                src/qt/locale/pawcoin_zh_CN.ts \
                src/qt/locale/pawcoin_zh_TW.ts
