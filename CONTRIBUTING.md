Contributing to PWC Core
============================

The PWC Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/pawcoin-project/pawcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PWC Core project, and is not to be
confused with overall PWC Network Protocol consensus changes.

Whether a pull request is merged into PWC Core rests with the project merge
...
Patches that change PWC consensus rules are considerably more involved than
...
Where a patchset proposes to change the PWC consensus, it must have been
...
The project leader is the release manager for each PWC Core release.
