...
/** Utility functions used by the PWC Qt UI.
 */
namespace GUIUtil
{
...
// Render PWC addresses in monospace font
...
// Parse "pawcoin:" URI into recipient object, return true on successful parsing
