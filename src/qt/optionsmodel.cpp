...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PWC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePawcoinAmount"))
        SoftSetArg("-anonymizepawcoinamount", settings.value("nAnonymizePawcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in pawcoin.cpp during shotdown to also remove the window positions
