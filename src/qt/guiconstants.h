...
/* Pawcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PWC"
#define QAPP_ORG_DOMAIN "pawcoin.org"
#define QAPP_APP_NAME_DEFAULT "PWC-Qt"
#define QAPP_APP_NAME_TESTNET "PWC-Qt-testnet"
