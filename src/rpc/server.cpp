...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pawcoin features */
        {"pawcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"pawcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pawcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pawcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pawcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pawcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pawcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pawcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"pawcoin", "startmasternode", &startmasternode, true, true, false},
        {"pawcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pawcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pawcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pawcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pawcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pawcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pawcoin", "preparebudget", &preparebudget, true, true, false},
        {"pawcoin", "submitbudget", &submitbudget, true, true, false},
        {"pawcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pawcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pawcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pawcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pawcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pawcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pawcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pawcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"pawcoin", "mnsync", &mnsync, true, true, false},
        {"pawcoin", "spork", &spork, true, true, false},
        {"pawcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> pawcoin-cli " + methodname + " " + args + "\n";
}
