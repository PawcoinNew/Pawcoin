...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (     0, uint256("0x00000f1838268f77422ccd9bca16b99e826950b9ca163c02136c6cdd0136c09d"))
    (    150, uint256("0x0000004677a840c12d56145439ad102c7b09811642638402b3de0b4979ea1e4c"))
    (    500, uint256("0x000000033ab25ccd7148b848597b996bc9dec8c6ebacd7a2f91e9879e7b70e63"))
    (   1000, uint256("0x72726259cba3ec864ce755e6734b8ffeca0a3f2a85a23ff39c2e2e6e102975a2"))
    (   7500, uint256("0x26b2f3a0a4c2f7c3bea252d8811a57b066845438a35eb1237c60a5a263e57ef0"))
    (  30000, uint256("0xcb37feb41ff7b0951054836f7342c418769d46b55da360f1e838818fdc15b4ee"))
    (  75000, uint256("0x189d54e24022567ed3e9ebed515fea3dfa521fb97796d653dacf692f047f372e"))
    ( 145000, uint256("0xa434ebb8082c2aa8ffa407e715840a81917e27719287ded3da5397ac3d20c69a"))
    ( 195000, uint256("0xef6fc2cc712ea49606e73f65abd6ac16633282fe2e5f34231281606363673b7d"))
    ( 205000, uint256("0x69ff878d8f658e3c79ae0f5b7308cfb730fad30896cf2e6aeee53850ce15ebea"))
    ( 209000, uint256("0xa98c370179adedd28f7c2722581c31dcdb13e4de1614a77f69476216b3130838"))
    ( 209323, uint256("0x9e4aa2f5dded307c2251934e3a22f4b3ff74b92d91772b63012a333370bdd9b8"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1613595805, // * UNIX timestamp of last checkpoint block
    421111,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
         ...
         */
        pchMessageStart[0] = 0x1a; // A
        pchMessageStart[1] = 0x2a; // B
        pchMessageStart[2] = 0x2e; // E
        pchMessageStart[3] = 0x78; // T-8
        ...
        nLastPOWBlock = 500;
        nPawcoinBadBlockTime = NEVER;
        nPawcoinBadBlocknBits = 0x1c056dac;
        ...
        nEnforceNewSporkKey = 1582038716;    // new spork always active on this chain.
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1586597615; // 
        genesis.nBits = 0x1e0ffff0; // 00000ffff0000000000000000000000000000000000000000000000000000000
        genesis.nNonce = 5045092;
		
        hashGenesisBlock = genesis.GetHash();	
        
        assert(hashGenesisBlock == uint256("0x00000753b038051aec9f568b5144cff38c271bac3df6b7cbe600f3449ae00a7f"));	
        ...
        strSporkKey = "0238a748d57cc19456182886f8c47ee8be3bafed3d650393819807033d45cb2052";
        strSporkKeyOld = "";
        strObfuscationPoolDummyAddress = "Pb5bNTKMKVJWLTDCwwEEvHH9MzDhxRaL5a";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // PWC: 1 minute
        nLastPOWBlock = 200;
        nPawcoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nPawcoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet pawcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet pawcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet pawcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet pawcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet pawcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetSpacing = 1 * 60;        // PWC: 1 minutes
