...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pawcoin Core pawcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pawcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pawcoin transaction") + "\n" +
                               "  pawcoin-tx [options] -create [commands]   " + _("Create hex-encoded pawcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pawcoin transaction
